...
('Sara Ahmed', 'Lahore', 'Punjab', '2022-02-10'),
('Omar Sheikh', 'Islamabad', 'Capital', '2022-03-05'),
('Fatima Noor', 'Peshawar', 'KPK', '2022-04-12'),
('Hassan Raza', 'Quetta', 'Balochistan', '2022-05-19'),
('Zainab Ali', 'Multan', 'Punjab', '2022-06-22'),
('Bilal Khan', 'Hyderabad', 'Sindh', '2022-07-15'),
('Ayesha Malik', 'Faisalabad', 'Punjab', '2022-08-08'),
('Usman Tariq', 'Sialkot', 'Punjab', '2022-09-25'),
('Maryam Javed', 'Rawalpindi', 'Punjab', '2022-10-30');
...
('Imran Ali', 'Sales', '2021-01-05'),
('Sana Khan', 'Sales', '2021-02-12'),
('Kamran Malik', 'Luxury Cars', '2021-03-18'),
('Hira Ahmed', 'Electric Cars', '2021-04-22'),
('Tariq Hussain', 'SUV Sales', '2021-05-15'),
('Mehwish Rafiq', 'Sales', '2021-06-10'),
('Adeel Farooq', 'Luxury Cars', '2021-07-25'),
('Shazia Bano', 'Sales', '2021-08-30'),
('Asad Iqbal', 'SUV Sales', '2021-09-14'),
('Rabia Khalid', 'Electric Cars', '2021-10-01');
...
SELECT MIN(SaleDate) AS EarliestSale,
       MAX(SaleDate) AS MostRecentSale
FROM Sales;
